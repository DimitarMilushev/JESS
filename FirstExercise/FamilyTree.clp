...
(deftemplate father-of (slot father) 
                       (slot child))
(deftemplate mother-of (slot mother) 
                       (slot child))
(deftemplate male (slot person))
(deftemplate female (slot person))
(deftemplate wife-of (slot wife) (slot husband))
(deftemplate husband-of (slot husband) 
                        (slot wife))
(deftemplate grandparent-of (slot grandparent) 
       (slot grandchild))
(deftemplate parent-of (slot parent) 
       (slot child))
(deftemplate sibling-of (slot sibling1) 
       (slot sibling2))
(deftemplate uncle-of (slot uncle) (slot neice))
(deftemplate aunt-of (slot aunt) (slot neice))
(deftemplate cousin-of (slot cousin) 
       (slot cousin))
(deftemplate brother-of (slot brother)
      (slot sibling))
(deftemplate sister-of (slot sister) 
      (slot sibling))
